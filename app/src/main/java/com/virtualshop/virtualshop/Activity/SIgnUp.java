    ...
    class ConfirmOTP extends AsyncTask<String , String ,String> {
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                ...
                url = new URL(APIs.Userverification);
        ...
        @Override
        protected void onPostExecute(String s) { progressDialog.dismiss();
            ...
            try {
                ...
                if (jsonObject.getBoolean("status")){
                    ...
                    Global.successDilogue(SIgnUp.this,jsonObject.getString("result"));
                }else {
                    //Toast.makeText(AddBeneficiary.this, jsonObject.getString("result"), Toast.LENGTH_LONG).show();
                    Global.failedDilogue(SIgnUp.this,jsonObject.getString("result"));
