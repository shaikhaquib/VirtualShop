...
public class BenificiaryList extends AppCompatActivity {
                               ...
                               //   viewHolder.imageView.setTag(position);
                                  ...
                                  viewHolder.layout.setOnClickListener(new View.OnClickListener() {
                                      ...
                                      public void onClick(View v) {
                                          ...
                                          if(current.status.equals("-1")){
                                              Global.diloge(BenificiaryList.this,"STATUS PENDING" , "YOUR BENEFICIARY STATUS IS IN PENDING PLEASE CONTACT SUPPORT TO ACTIVATE");
...
//        Create a new TextDrawable for our image's background
                                  ...
                                  viewHolder.menu.setOnClickListener(new View.OnClickListener() {
                                      ...
                                      public void onClick(View v) {
                                          ...
                                          if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                                              builder = new AlertDialog.Builder(BenificiaryList.this);
                                          } else {
                                              builder = new AlertDialog.Builder(BenificiaryList.this);
                                          }
                  ...
                  new Response.ErrorListener() {
                      ...
                      public void onErrorResponse(VolleyError error) {
                          // error
                          Dissmiss();
                          final Dialog dialog = new Dialog(BenificiaryList.this);
...
//        Create a new TextDrawable for our image's background
      ...
      private void deleteBenificiary(String id, String agentid, final String unique_id, final String beneficiary_id)
      {
          StringRequest request =new StringRequest(StringRequest.Method.POST, APIs.BeniDelete, new Response.Listener<String>() {
              ...
              public void onResponse(String response) {
                  ...
                  try {
                      JSONObject jsonObject =new JSONObject(response);
                      Toast.makeText(BenificiaryList.this, jsonObject.getString("result"), Toast.LENGTH_SHORT).show();
                  } catch (JSONException e) {
                      e.printStackTrace();
                  }
      ...
      private void initialize() {
          ...
          dialog = new ProgressDialog(BenificiaryList.this);
